<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProudect.aspx.cs" Inherits="MyProjectIPA.Employe.EditProudect" %>
            ...
            <asp:TemplateField HeaderText="Name">
                   ...
                   <asp:TemplateField HeaderText="CategoryID">
                       ...
                       <asp:TemplateField HeaderText="ImgFile">
                        <ItemTemplate>
                            <asp:Image ID="Image1" src='<%# Eval("ImgFile") %>'  runat="server" />
                        </ItemTemplate>
                        <EditItemTemplate>
