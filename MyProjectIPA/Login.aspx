<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" ValidateRequest="false"  Inherits="MyProjectIPA.Login"  EnableEventValidation="false"%>
            ...
            <div class="container-fluid h-custom">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1" style="color: #000000">
                        <div class="auto-style1">Login User</div>
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            ...
                            <p class="plink" style="color: black">
                                <span class="auto-style9">Don't have an account? </span><a href="SingUP.aspx"
                                    class="link-danger">

                                    <span class="auto-style9">Register</span></a>
                            </p>
                            <br />
                                                        <p class="plink2" style="color: black">
                                                            <span class="auto-style9">Forgot password? ? </span><a href="ResetPassword.aspx"
                                    class="link-danger">

                                    <span class="auto-style9">Rest Password</span></a>
                            </p>
