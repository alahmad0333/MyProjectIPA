...
{
    public partial class LoginEmploye : System.Web.UI.Page
    {
        ...
        protected void Buttonlogin_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand com2 = new SqlCommand("select * from Employe where Email = @em and Password = @pass", con);
            ...
            if (com2.ExecuteReader().HasRows)
            {
                ...
                Response.Redirect("AddProudect.aspx");
                con.Close();
            }
