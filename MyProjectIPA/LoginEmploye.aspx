<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginEmploye.aspx.cs" Inherits="MyProjectIPA.LoginEmploye" %>
            ...
            <div class="container-fluid h-custom">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1" style="color: #000000">
                        <div class="auto-style1">Login Employee</div>
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            <asp:Button ID="Buttonlogin" CssClass="btn btn-primary btn-lg"
                                Style="padding-left: 2.5rem; padding-right: 2.5rem; right: -462px; top: 0px;" runat="server" Text="Login" OnClick="Buttonlogin_Click" />
