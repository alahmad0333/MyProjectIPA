<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="MyProjectIPA.ResetPassword" %>
    ...
    <nav class="navbar navbar-expand-sm navbar-dark bg-dark">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="mynavbar">
                        ...
                        <asp:Button ID="Butlong10" runat="server" Text="Login" CssClass="auto-style8"  />
                    </div>
                </div>
            </nav>
            ...
            <div class="container-fluid h-custom">
                <div class="row d-flex justify-content-center align-items-center h-100">
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1" style="color: #000000">
                        <div class="auto-style1">Rest Password</div>
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <asp:TextBox ID="Emailtext" placeholder="Enter your email address" CssClass="form-control form-control-lg" runat="server"></asp:TextBox>
                        </div>

                        <!-- Password input -->

                        <div class="text-center text-lg-start mt-4 pt-2">
                            <asp:Button ID="SendPassword" CssClass="btn btn-primary btn-lg"
                                Style="padding-left: 2.5rem; padding-right: 2.5rem;" runat="server" Text="Send To Email" OnClick="SendPassword_Click" />
